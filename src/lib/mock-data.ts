...
function av(file: string): string {
  return `/avatars/${file}`;
}
...
export const CREATORS: Creator[] = [
  ...
  },
  {
    ...
    photoUrl: av("eleanor-wilkes.jpg"),
    category: "Fashion",
    agent: "Maddie" as Agent,
    platforms: ["tiktok", "instagram", "youtube_shorts"],
    analytics: {
  ...
  },
  {
    ...
    photoUrl: av("northern-funny-mummy.jpg"),
    category: "Sketch Comedy",
    agent: "Maddie" as Agent,
    platforms: ["tiktok", "instagram"],
    analytics: {
  ...
  },
  {
    ...
    photoUrl: av("rhys-drakeford.jpg"),
    category: "Sketch Comedy",
    agent: "Maddie" as Agent,
    platforms: ["tiktok", "instagram", "youtube_shorts"],
    analytics: {
