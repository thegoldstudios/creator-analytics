export default function PrivacyPolicy() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 text-gray-800">
      ...
      <p className="mb-6">
        This Privacy Policy describes how The Gold Studios Ltd ("we", "us", or "our") collects, uses, and protects information obtained through our Creator Analytics platform ("the Platform"). By connecting your social media accounts or using the Platform, you agree to the terms of this policy.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">1. Who We Are</h2>
      <p className="mb-6">
        The Gold Studios Ltd is a talent management agency that represents social media creators across TikTok, Instagram, and YouTube. Our Creator Analytics platform enables creators we represent to securely connect their social media accounts so that we can track performance, prepare campaign reports, and support their professional development.
      </p>
      <p className="mb-6">
      ...
      <p className="mb-4">When you connect your social media accounts to our Platform, we may collect the following information:</p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        <li>To display analytics dashboards showing your content performance across platforms</li>
      ...
      <p className="mb-6">
        Our Platform integrates with TikTok, Instagram (Meta), and YouTube (Google) via their official APIs. Your use of those platforms is governed by their respective privacy policies. We only request access to data scopes that are necessary for the purposes described in this policy, and we do not access your data beyond what you explicitly authorise.
      </p>
